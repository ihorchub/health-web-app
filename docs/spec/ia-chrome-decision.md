...
**Hero asset:** `apps/web/public/brand/hero/scr02-hero-doctor-lika.png` · doctor avatars: `apps/web/public/brand/doctor-avatars/`.
...
~~Banner final art/copy on SCR-02~~ — locked with Paper SoT + `apps/web/public/brand/hero/scr02-hero-doctor-lika.png` (27 Aug 2026).
